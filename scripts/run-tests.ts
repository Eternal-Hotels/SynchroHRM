...
await run("office 365 MFA PDFs remain unsupported because they are not property reports", async () => {
  const fixturePath = path.resolve(
    ...
    "2025-08-25",
    "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAAAALuZAAA__Office_365_Multi_Factor_Authentication.pdf"
  );
...
await run("manual sync ignores the saved delta token and performs a full inbox rescan", async () => {
  ...
  try {
    ...
    const seenDeltaTokens: Array<string | null> = [];
    const source = {
      async pullAttachments(deltaToken: string | null) {
...
await run("previously unsupported holiday and ellensburg report families now parse into dedicated exports", async () => {
  const fixtures = [
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-pendleton-adjustment-activity",
        "2026-05-26",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZnAAA__May_26_2026-PDTOR-Holiday_Inn_ExpressPendleton-adjustment-activity.pdf"
      ),
      reportType: "adjustment_refund_activity_rows",
      reportDate: "2026-05-25",
      minRows: 8,
      probe: (rows: Record<string, unknown>[]) => {
    ...
    },
    {
      path: path.resolve(
        ...
        "2026-05-26",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZnAAA__May_26_2026-PDTOR-Holiday_Inn_ExpressPendleton-all-transactions.pdf"
      ),
    ...
    },
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-pendleton-closed-folios-balance",
        "2026-05-26",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZnAAA__May_26_2026-PDTOR-Holiday_Inn_ExpressPendleton-closed-folios-balance.pdf"
      ),
    ...
    },
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-pendleton-in-house-guest-folio-balances",
        "2026-05-26",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZnAAA__May_26_2026-PDTOR-Holiday_Inn_ExpressPendleton-in-house-guest-folio-balances.pdf"
      ),
    ...
    },
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-pendleton-trial-balance-report",
        "2026-05-26",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZnAAA__May_26_2026-PDTOR-Holiday_Inn_ExpressPendleton-trial-balance-report.pdf"
      ),
    ...
    },
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-ellensburg-rate-report",
        "2026-05-20",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC0FPF1AAA__May_19_2026-ELNWA-Holiday_Inn_ExpressEllensburg-rate-report.pdf"
      ),
    ...
    },
    {
      path: path.resolve(
        "storage",
        "raw",
        "holiday-inn-express-ellensburg-reservations",
        "2026-05-20",
        "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC0FPF1AAA__May_19_2026-ELNWA-Holiday_Inn_ExpressEllensburg-reservations.pdf"
      ),
  ...
  for (const fixture of fixtures) {
    ...
    fixture.probe(parsed.rows as Record<string, unknown>[]);
  }
});

await run("attachment-name fallback strips Ellensburg report suffixes before slugging", async () => {
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 19, 2026-ELNWA-Holiday Inn ExpressEllensburg-occupancy.pdf"),
    {
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 19, 2026-ELNWA-Holiday Inn ExpressEllensburg-rate-report.pdf"),
    {
      propertyName: "Holiday Inn Express Ellensburg",
      propertySlug: "holiday-inn-express-ellensburg"
    }
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 19, 2026-ELNWA-Holiday Inn ExpressEllensburg-reservations.pdf"),
    {
      propertyName: "Holiday Inn Express Ellensburg",
      propertySlug: "holiday-inn-express-ellensburg"
    }
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 26, 2026-PDTOR-Holiday Inn ExpressPendleton-adjustment-activity.pdf"),
    {
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 26, 2026-PDTOR-Holiday Inn ExpressPendleton-closed-folios-balance.pdf"),
    {
      propertyName: "Holiday Inn Express Pendleton",
      propertySlug: "holiday-inn-express-pendleton"
    }
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 26, 2026-PDTOR-Holiday Inn ExpressPendleton-in-house-guest-folio-balances.pdf"),
    {
      propertyName: "Holiday Inn Express Pendleton",
      propertySlug: "holiday-inn-express-pendleton"
    }
  ...
  assert.deepEqual(
    derivePropertyRefFromAttachmentName("May 26, 2026-PDTOR-Holiday Inn ExpressPendleton-trial-balance-report.pdf"),
    {
      propertyName: "Holiday Inn Express Pendleton",
      propertySlug: "holiday-inn-express-pendleton"
    }
...
await run("comfort kennewick daily packet parses into structured audit bundle rows", async () => {
  const fixturePath = path.resolve(
    ...
    "comfort-inn-wa701",
    "2026-05-26",
    "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZkAAA__All_Night_Audit_Reports_WA701_COMFORT_KENNEWICK_DAILY_PDF_FOR_NETSUITE_2026-05-25.pdf"
  );
  if (!(await pathExists(fixturePath))) {
    return;
  }
  ...
  const taxExemptSection = parsed.rows.find(
    (row) => row.report_name === "Tax Exempt Report" && row.section === "Tax Exempt Revenue Summary - By Tax:"
  );
...
await run("sleep inn pasco daily packet also parses into structured audit bundle rows", async () => {
  const fixturePath = path.resolve(
    ...
    "sleep-inn-wa102",
    "2026-05-26",
    "AAMkADY4MjQ5NjFkLTRjZTktNGFiZS05ZDhjLWNiMDAxMWVmZjNhYgBGAAAAAADvcm92xvZDSLd2s0tgIkcIBwA71flkJMjiQK5tdwwB3oCMAAAAAAEMAAA71flkJMjiQK5tdwwB3oCMAAC4yLZeAAA__All_Night_Audit_Reports_WA102_SLEEP_INN_PASCO_DAILY_REPORTS_PDF_FOR_NETSUITE_2026-05-25.pdf"
  );
  if (!(await pathExists(fixturePath))) {
    return;
  }
...
await run("downloaded csv responses use property-aware filenames", async () => {
  ...
  try {
    ...
    try {
      ...
      const parsedAttachment = propertyAttachments.find((attachment) =>
        attachment.status === "parsed" && attachment.report_type === "history_forecast_rows"
      );
      assert.ok(parsedAttachment);

      const parsedCsvResponse = await fetch(
        `${baseUrl}/api/attachments/${encodeURIComponent(String(parsedAttachment.id))}/parsed-csv`,
        {
          headers: {
            cookie: adminCookie
          }
      ...
      assert.equal(
        parsedCsvResponse.headers.get("content-disposition"),
        `attachment; filename="${buildParsedCsvDownloadName({
      ...
      const latestDownloadResponse = await fetch(
        `${baseUrl}/api/properties/${encodeURIComponent(propertySlug)}/exports/history_forecast_rows/latest?download=1`,
        {
          headers: {
            cookie: adminCookie
          }
      ...
      assert.equal(
        latestDownloadResponse.headers.get("content-disposition"),
        `attachment; filename="${buildLatestExportDownloadName({
          propertySlug,
          reportType: "history_forecast_rows",
...
function buildLoginRequestBody(username: string, password: string, authorizedUserConfirmed = true): string {
