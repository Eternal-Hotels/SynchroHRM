...
function buildSupportedAttachmentGroupKey(attachment, reportType) {
...
function prefersSupportedAttachment(candidate, current) {
...
function supportedAttachmentRank(attachment) {
